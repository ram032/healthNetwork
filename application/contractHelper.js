...
async function getContractInstance(organisationRole) {
	...
	let connectionProfile = yaml.load(fs.readFileSync('./connection-profile-' + organisationRole.toLowerCase() +'.yaml', 'utf8'));
	...
	return channel.getContract('PharmaNetwork', 'Drug-counterfieting.pharmanet');
}
